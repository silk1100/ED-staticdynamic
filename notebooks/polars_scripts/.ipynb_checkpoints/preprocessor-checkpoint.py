...
class Preprocessor(BaseEstimator, TransformerMixin):
    ...
    def transform(self, Xtest:pl.DataFrame, y=None):
        ...
        # Xdte = pl.concat([X_dynamic_te.drop(["Type_NORM", "EVENT_NAME_NORM", "dxcode_list"]+self.dynamic_obj.num_cols),
        ...
        #                             "arr_month", "arr_day", "arr_dow", "holiday", "arr_hour"]+self.static_obj.num_cols), Xpre_static_te], how='horizontal')
        Xste = pl.concat([X_static_te.drop(["Ethnicity", "FirstRace", "Sex", "Acuity_Level",
                                    "Means_Of_Arrival", "Coverage_Financial_Class_Grouper",
                                    "Arrived_Time", 'cc_list',
                                    "arr_month", "arr_day", "arr_dow", "holiday", "arr_hour"]+self.static_obj.num_cols), Xpre_static_te], how='horizontal')
